package fr.maxlego08.cookie.inventory;
...
import fr.maxlego08.cookie.exceptions.InventoryOpenException;
import fr.maxlego08.cookie.zcore.utils.ZUtils;
import fr.maxlego08.cookie.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.cookie.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.cookie.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected CookiePlugin plugin;
	...
	protected InventoryResult preOpenInventory(CookiePlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(CookiePlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, CookiePlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, CookiePlugin plugin, Player player) {
	}
