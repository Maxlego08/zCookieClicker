package fr.maxlego08.cookie.zcore;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import fr.maxlego08.cookie.CookiePlugin;
import fr.maxlego08.cookie.command.CommandManager;
import fr.maxlego08.cookie.command.VCommand;
import fr.maxlego08.cookie.exceptions.ListenerNullException;
import fr.maxlego08.cookie.inventory.VInventory;
import fr.maxlego08.cookie.inventory.ZInventoryManager;
import fr.maxlego08.cookie.listener.AdapterListener;
import fr.maxlego08.cookie.listener.ListenerAdapter;
import fr.maxlego08.cookie.placeholder.LocalPlaceholder;
import fr.maxlego08.cookie.placeholder.Placeholder;
import fr.maxlego08.cookie.zcore.enums.EnumInventory;
import fr.maxlego08.cookie.zcore.logger.Logger;
import fr.maxlego08.cookie.zcore.utils.storage.NoReloadable;
import fr.maxlego08.cookie.zcore.utils.storage.Persist;
import fr.maxlego08.cookie.zcore.utils.storage.Savable;
import fr.maxlego08.cookie.zcore.utils.gson.LocationAdapter;
import fr.maxlego08.cookie.zcore.utils.gson.PotionEffectAdapter;
import fr.maxlego08.cookie.zcore.utils.plugins.Plugins;
...
public abstract class ZPlugin extends JavaPlugin {
    ...
    protected void preEnable() {
        ...
        LocalPlaceholder.getInstance().setPlugin((CookiePlugin) this);
        ...
        this.commandManager = new CommandManager((CookiePlugin) this);
        this.inventoryManager = new ZInventoryManager((CookiePlugin) this);

        /* Add Listener */
        this.addListener(new AdapterListener((CookiePlugin) this));
